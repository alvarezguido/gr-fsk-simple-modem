...
class fskDem(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "fskDem", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("fskDem")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fskDem")
        ...
        self.freq = freq = 449962800

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(449500000, 450500000, 100, 449962800, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "'freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_win)
        self._threshold_range = Range(-90, -60, 1, -70, 200)
        ...
        labels = ['bit 1', 'bit 0', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_threshold_ff_0_0 = blocks.threshold_ff(0.015, 0.015, 0)
        self.blocks_threshold_ff_0 = blocks.threshold_ff(0.015, 0.015, 0)
        ...
        self.band_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate/20, analog.GR_COS_WAVE, -20e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate/20, analog.GR_COS_WAVE, 20e3, 1, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        self.connect((self.blocks_complex_to_mag_0, 0), (self.blocks_threshold_ff_0, 0))
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.blocks_threshold_ff_0_0, 0))
        ...
        self.connect((self.blocks_threshold_ff_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_complex_to_mag_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_0_0.set_sampling_freq(self.samp_rate/20)
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate/20, 15e3, 25e3, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate/20, 3e3, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate/20, 3e3, 100, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate/20)
        self.qtgui_time_sink_x_1_0_0.set_samp_rate(self.samp_rate/20)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0, self.samp_rate/20)
...
def main(top_block_cls=fskDem, options=None):
